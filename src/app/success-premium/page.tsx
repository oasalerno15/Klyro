    ...
    <div className="min-h-screen relative" style={{ backgroundColor: '#fefce8' }}>
      ...
      <div className="relative z-10 min-h-screen flex items-center justify-center px-4">
        <div className="max-w-md w-full bg-white rounded-2xl shadow-xl p-8 text-center">
          ...
          <h1 className="text-2xl font-bold text-gray-900 mb-4">Welcome to Klyro Premium!</h1>
          <p className="text-gray-600 mb-6">Your subscription is now active with unlimited access to all features.</p>
