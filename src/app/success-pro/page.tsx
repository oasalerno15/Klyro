      ...
      <div className="relative z-10 min-h-screen flex items-center justify-center px-4">
        ...
        >
          ...
          <div className="bg-white/80 backdrop-blur-lg rounded-2xl shadow-2xl border border-green-200/30 overflow-hidden">
            {/* Header */}
            <div className="bg-gradient-to-r from-emerald-600 to-green-700 px-8 py-8 text-center relative overflow-hidden">
              {/* Subtle Pattern */}
              ...
              >
                <div className="text-center mb-6">
                  ...
                  <p className="text-sm text-gray-600">
                    Everything you need for advanced financial tracking
                  </p>
                </div>
                
                <div className="space-y-3">
                  {[
                    { icon: "📊", text: "50 transactions/month", delay: 1.0 },
                    { icon: "📸", text: "50 receipt scans/month", delay: 1.1 },
                    { icon: "🧠", text: "100 AI conversations/month", delay: 1.2 },
                    { icon: "📈", text: "Advanced analytics & insights", delay: 1.3 }
                  ].map((feature, index) => (
                    <motion.div
                      key={index}
                      ...
                      className="flex items-center space-x-3 p-3 rounded-lg bg-emerald-50 border border-emerald-100"
                    >
