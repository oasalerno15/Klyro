  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 flex items-center justify-center px-4">
      <motion.div
        ...
        className="max-w-md w-full bg-white rounded-lg shadow-xl p-8 text-center border-t-4 border-blue-500"
      >
        <motion.div
          initial={{ scale: 0 }}
          animate={{ scale: 1 }}
        ...
        <h1 className="text-2xl font-bold text-gray-900 mb-2">Welcome to Klyro Pro!</h1>
        <p className="text-gray-600 mb-6">
          Your Pro subscription has been activated. You now have access to our most popular features:
        </p>
        ...
        {processing ? (
          <div className="flex items-center justify-center">
            ...
            <span className="text-gray-600">Setting up your Pro account...</span>
          </div>
        ) : (
